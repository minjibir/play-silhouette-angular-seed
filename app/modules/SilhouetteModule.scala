...
class SilhouetteModule extends AbstractModule with ScalaModule {
  ...
  def provideAuthenticatorService(
    ...
    val config: JWTAuthenticatorSettings = configuration.get[JWTAuthenticatorSettings]("silhouette.authenticator")
  ...
  def provideOAuth1TokenSecretProvider(
    ...
    //    val settings: CookieSecretSettings = configuration.underlying.as[CookieSecretSettings]("silhouette.oauth1TokenSecretProvider")
    val settings: CookieSecretSettings = configuration.get[CookieSecretSettings]("silhouette.oauth1TokenSecretProvider")
